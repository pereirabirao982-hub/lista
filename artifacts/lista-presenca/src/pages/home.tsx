    ...
    <div className="paper-grain min-h-[100dvh] overflow-hidden bg-background">
      ...
      <main>
        <section className="relative mx-auto grid max-w-7xl gap-12 px-6 pb-20 pt-10 sm:px-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-16 lg:px-12 lg:pb-32 lg:pt-20">
          ...
          <div className="relative mt-8 animate-fade-in-up delay-200 lg:min-h-[550px] lg:mt-0">
            ...
            <div className="relative ml-auto w-[96%] max-w-[440px] rounded-[2.5rem] border border-border/60 bg-card/90 p-8 shadow-2xl backdrop-blur-sm lg:absolute lg:right-0 lg:top-4 lg:w-[90%] lg:p-12">
            ...
            <div className="relative z-10 mt-5 flex w-[55%] max-w-[240px] -rotate-3 flex-col gap-4 rounded-[2rem] bg-accent p-6 text-accent-foreground shadow-2xl transition-transform duration-500 hover:rotate-0 lg:absolute lg:-bottom-6 lg:left-0 lg:mt-0 lg:p-8">
